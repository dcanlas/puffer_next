          ...
          <div className="row">
            ...
            <div className="image-column col-xl-6 col-lg-6">
              <div className="inner-column wow fadeInLeft">
                ...
                <figure className="image-2 overlay-anim wow fadeInLeft">
                ...
                <div className="exp-box bounce-y">
                  <figure className=" overlay-anim wow fadeInLeft">
                    <img src="images/resource/exp-icon.png" alt="" />
                  </figure>
                  <h4 className="title">Luxury Room</h4>
                  <div className="text">
                    Donec in quis the asd <br />
                    pellentesque velit. Donec id <br />
